 ...
 * 'controllerMap' => [
 *     'assignment' => [
 *         'class' => 'frontend\modules\admin\controllers\AssignmentController',
...
class Module extends \yii\base\Module
{
     ...
     * Its used when `layout` set to 'left-menu', 'right-menu' or 'top-menu'.
     */
    public $mainLayout = '@frontend/modules/admin/views/layouts/main.php';
    /**
     * @var array
     * @see [[menus]]
     */
    ...
    public function init()
    {
        ...
        if (class_exists('yii\jui\JuiAsset')) {
            Yii::$container->set('frontend\modules\admin\AutocompleteAsset', 'yii\jui\JuiAsset');
        }
    }
